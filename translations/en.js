export default {
  ...
  'queue-wrong-url': 'Video connection address must start with http:// or https://',
  'queue-call-url': 'Video connection address:',
  'queue-call-url-help': 'If there is a video conference tool in use (e.g. Zoom), you can paste here the address to join the call.',
  ...
  'manage-user-row-template': '{location}',
  ...
  'manage-th-connection': 'Connection',
  ...
  'notification-joined-queue': '{name} joined the queue.',
