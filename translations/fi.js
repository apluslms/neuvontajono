export default {
  ...
  'queue-wrong-url': 'Videoyhteyden osoitteen tulee alkaa http:// tai https://',
  'queue-call-url': 'Videoyhteyden osoite:',
  'queue-call-url-help': 'Jos käytössä on videoneuvotteluohjelma (esim. Zoom), voit liittää tähän linkin puheluun liittymiseksi.',
  ...
  'notification-joined-queue': '{name} on jonossa.',
